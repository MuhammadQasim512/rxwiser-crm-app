                          ...
                          <div className="row">
                            ...
                            >
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select className="form-control" id="SexId" name="SexId">
                            ...
                            >
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select className="form-control" id="Diary" name="Diary">
                              ...
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select
                                    className="form-control"
                                    data-val="true"
                                    data-val-required="The ArchivedOrFlaggedForDeletion field is required."
                                    id="ArchivedOrFlaggedForDeletion"
                                    name="ArchivedOrFlaggedForDeletion"
                                  >
                            ...
                            >
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select className="form-control" id="Referrer" name="Referrer">
                              ...
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select
                                    className="form-control"
                                    data-val="true"
                                    data-val-required="The CommunicationMethod field is required."
                            ...
                            >
                              <div className="form-group row">
                                ...
                                <div className="col-12 col-lg-9">
                                  <select
                                    className="form-control"
                                    id="ReceivesSmsStatus"
                                    name="ReceivesSmsStatus"
                                  >
