                        ...
                        <div className="card">
                            ...
                            <div style={{ padding: 20 }}>
                                <div className="panel-body">
                                    <div
                                        className="dropzone dropzone-multiple p-0 mb-5 dz-clickable"
                                            ...
                                            <table className="table table-sm fs-9 mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {/* <th class="sort border-top border-translucent desc" data-sort="age">Action</th> */}
                                                    </tr>
                                                </thead>
