                ...
                <TabPane tabId="2">
                  <Row>
                    <>
                      ...
                      >
                        <div className="form-group row">
                          <label className="col-form-label col-12">Member Telephone:</label>
                          <div className="col-12 col-lg-9">
                            <input
                              className="form-control"
                              id="telephone"
                      ...
                      >
                        <div className="form-group row">
                          <label className="col-form-label col-12">Member Email:</label>
                          <div className="col-12 col-lg-9">
                            <input
                              className="form-control"
                              id="MemberEmail"
                              name="MemberEmail"
                              title="Filter by any part of the MemberEmail name"
                              type="text"
                              defaultValue=""
                            />
                          </div>
                      ...
                      >
                        <div className="form-group row">
                          <label className="col-form-label col-12">Primary Practitioner:</label>
                          <div className="col-12 col-lg-9">
                            <select
                              className="form-select"
                              aria-label="Default select example"
                              style={{ fontSize: 12, color: "#1c1d1e" }}
                            >
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-12 col-lg-9">
                            <select
                              ...
                              style={{ fontSize: 12, color: "#1c1d1e" }}
                            >
                              <option value="">Non-Archived Only:</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div className="row mt-4">
                          ...
                          <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb10">
                            <div className="form-group row">
                              <label className="col-form-label col-12" htmlfor="practitionerIds">
                          ...
                          <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb10">
                            <div className="form-group row">
                              <label className="col-form-label col-12">Appointment Location:</label>
                              <div className="col-12 col-lg-9">
                                <select
                                  className="form-select"
                                  aria-label="Default select example"
            ...
            <div id="search-option-advanced" className="collapse">
              <div className="row">
                <div className="col-12 mt20" id="searchFilters">
                  <form id="advanced-seach-form" action="/Profile/Shared/Search">
                    <div className="row">
                      <input
                        id="client-role-raw"
                        name="ClientType"
