                    ...
                    <div className="dashboard-content">
                        <div className="card">
                            <div className="panel-body">
                                <h3 className="profile-det">Appointment Statistics</h3>
                                <hr />
                                <div className="row">
                                    <div className="col-lg-3 col-12  mt20">
                                        <div className="border-box-blue text-center text-blue text-bold">
                                            <div className="font-34"> 0</div>
                                            <div className="font-11">TOTAL APPOINTMENTS</div>
                                        </div>
                                    </div>
                                    <div className="col-lg-9 col-12 border-left">
                                        <div className="row mt20 border-bottom padding-bottom-20">
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray padding-bottom-20">
                                                    TOTAL ATTENDED
                                                </div>
                                                <div className="font-34 text-bold text-dark-gray mt20">
                                                    0{/* <i class="fa fa-bar-chart font-16 text-base-color"></i> */}
                                                </div>
                                            </div>
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray">
                                                    ATTENDED APPOINTMENT THIS CALENDAR YEAR
                                                </div>
                                                <div className="font-34 text-bold text-dark-gray mt20">
                                                    0{" "}
                                                    {/* <i class="fa fa-bar-chart font-16 text-base-color"></i> */}
                                                </div>
                                            </div>
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray">
                                                    ATTENDED APPOINTMENTS SINCE LAST REFERRAL
                                                </div>
                                                <div className="font-34 text-bold text-dark-gray mt20">0</div>
                                            </div>
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray padding-bottom-20">
                                                    FUTURE APPOINTMENTS
                                                </div>
                                                <div className="font-34 text-bold text-dark-gray mt10">0</div>
                                            </div>
                                        </div>
                                        <div className="row mt20 border-bottom padding-bottom-20">
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray">NO SHOWS</div>
                                                <div className="font-34 text-bold text-dark-gray mt20">0</div>
                                            </div>
                                            <div className="col-6 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray">
                                        ...
                                        <div className="row mt20 padding-bottom-20">
                                            <div className="col-12 col-sm-3">
                                                <div className="font-11 text-bold text-dark-gray">
                                                    <span
                                                        ...
                                                        data-toggle="tooltip"
                                                        data-placement="top"
                                                        data-original-title="Appointments attended versus all appointments scheduled to attend"
                                                    >
                                                        ATTENDANCE RATE
                                                    </span>
                                                </div>
                                                <div className="mt20">
                                                    <span className="text-base-color text-bold">0%</span>
                                                    <progress
                                                        className="progress progress-success progress-value-color-orange"
                                                        value={0}
                                                        max={100}
                                                    ></progress>
                                                </div>
